...
export const initializeSetup = async () => {
  const response = await api.post(`${API_URL}/initialize`);
  return response.data;
};
...
export const saveOrganizationType = async (payload) => {
  const response = await api.post(`${API_URL}/step-2`, payload);
  return response.data;
};
...
export const uploadSchoolLogo = async (file) => {
  ...
  const response = await api.post(`${API_URL}/step-3/logo`, formData, {
...
export const deleteExaminationGradeRow = async (rowId) => {
  ...
  const response = await api.delete(`${API_URL}/step-9/grade-rows/${encoded}`);
  return response.data;
};
...
export const saveFeeSetup = async (payload) => {
  const response = await api.post(`${API_URL}/step-10`, payload);
  return response.data;
};

/** Save step 11 communication setup */
export const saveCommunicationSetup = async (payload) => {
  const response = await api.post(`${API_URL}/step-11`, payload);
  return response.data;
};

/** Get step 12 review summary */
export const getSetupReview = async () => {
  const response = await api.get(`${API_URL}/step-12/review`);
  return response.data;
};
