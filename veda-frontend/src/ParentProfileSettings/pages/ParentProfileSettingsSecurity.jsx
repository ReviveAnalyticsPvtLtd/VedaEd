...
const handlePasswordChange = () => {
  navigate("/parent/settings/security/password");
};

const handleTwoFactor = () => {
  navigate("/parent/settings/security/two-factor-auth");
};

const handleSessionManagement = () => {
  navigate("/parent/settings/security/sessions");
};

const handleAccountControl = () => {
  navigate("/parent/settings/security/account-control");
};
