...
export default function TeacherProfileSettingsSecurity() {
  const [loading, setLoading] = useState(true);
const navigate = useNavigate();


const handlePasswordChange = () => {
  navigate("/teacher/settings/security/password");
};

const handleTwoFactor = () => {
  navigate("/teacher/settings/security/two-factor-auth");
};

const handleSessionManagement = () => {
  navigate("/teacher/settings/security/sessions");
};

const handleAccountControl = () => {
  navigate("/teacher/settings/security/account-control");
};
