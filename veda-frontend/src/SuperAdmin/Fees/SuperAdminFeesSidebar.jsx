...
export default function SuperAdminFeesSidebar({
  searchQuery = "",
  isSidebarOpen,
  setIsSidebarOpen,
}) {
  ...
  const menuItems = [
    ...
    {
      name: "Collect Fees",
      path: "/superadmin/fees/collect",
      icon: <FiDollarSign size={18} />,
    },
    {
      name: "Fee Master",
      path: "/superadmin/fees/master",
      icon: <FiDollarSign size={18} />,
    },
    {
      name: "Discounts",
      path: "/superadmin/fees/discounts",
      icon: <FiDollarSign size={18} />,
    },
  ];
      ...
      <ul className="mt-14 space-y-1 px-3">
        {filteredItems.map((item) => {
          const isActive = item.isDashboard
            ? location.pathname === "/superadmin/fees" ||
              location.pathname.startsWith("/superadmin/fees/dashboard")
      ...
      <div className="absolute bottom-4 w-full px-2">
        ...
        {settingsOpen && isSidebarOpen && (
          <div className="ml-10 mt-3 space-y-2 text-sm text-gray-700">
            <NavLink
              to="/superadmin/fees/settings/profile"
              className="hover:text-blue-600 block"
            >
              Profile Settings
            </NavLink>
            <NavLink
              to="/superadmin/fees/settings/account"
              className="hover:text-blue-600 block"
            >
              Account Settings
            </NavLink>
        ...
        <div className="mt-4">
          {isSidebarOpen ? (
            <div className="p-3 bg-gray-50 rounded-lg">
              <div className="text-sm font-medium">Fees Admin</div>
