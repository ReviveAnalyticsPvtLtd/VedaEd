...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-3 mt-4">
  ...
  type="button"
  disabled
  title="Enquiries can only be added from Admin"
...
<td className="p-2 border text-center font-medium">
  ...
  <div className="flex justify-center items-center gap-2">
    ...
    <button
      type="button"
      disabled
      title="Edit is not available for Super Admin"
      className="p-1.5 rounded border border-gray-200 text-gray-400 cursor-not-allowed"
    >
      <FiEdit2 />
    </button>

    {/* Mark Review - Disabled */}
    {e.status !== "reviewed" && (
      <button
        type="button"
        disabled
        title="Status update is not available for Super Admin"
        className="text-xs border px-2 py-1 rounded bg-gray-100 text-gray-400 border-gray-200 cursor-not-allowed"
      >
        Mark Review
      </button>
    )}
    ...
    <button
      type="button"
      disabled
      title="Delete is not available for Super Admin"
      className="p-1.5 rounded text-gray-400 cursor-not-allowed"
    >
      <FiTrash2 />
    </button>
