...
export function useOnboardingStep5() {
  ...
  // Prevents double OTP send caused by React Strict Mode double-invoking useEffect
  ...
  const bootstrapOtp = useCallback(async () => {
    // Guard: only run once across React Strict Mode double-invocation
    if (bootstrapCalledRef.current) return null;
