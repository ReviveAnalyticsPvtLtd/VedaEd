...
export default function StudentProfileSettingsSecurity() {
  const [loading, setLoading] = useState(true);
const navigate = useNavigate();
const handlePasswordChange = () => {
  navigate("/student/settings/security/password");
};

const handleTwoFactor = () => {
  navigate("/student/settings/security/two-factor-auth");
};

const handleSessionManagement = () => {
  navigate("/student/settings/security/sessions");
};

const handleAccountControl = () => {
  navigate("/student/settings/security/account-control");
};
