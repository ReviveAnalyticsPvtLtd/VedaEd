...
const handlePasswordChange = () => {
  navigate("/superadmin/settings/security/password");
};

const handleTwoFactor = () => {
  navigate("/superadmin/settings/security/two-factor");
};

const handleSessionManagement = () => {
  navigate("/superadmin/settings/security/sessions");
};

const handleAccountControl = () => {
  navigate("/superadmin/settings/security/account-control");
};
